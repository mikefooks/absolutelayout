var Layout = (function (w, d, undefined) {
    "use strict";
    ...
    return function Layout(columns, rows, container) {
        var layout = Object.create(layoutProto);
        layout.columns = columns;
        layout.rows = rows;
        layout.containerClass = container;
        layout.el = document.querySelector(container);
        layout.cellClass = "cell";
